...
5. Пользователь скачивает XLSX по выбранной поставке. Технический период запроса 1С сервис вычисляет по датам поставки и ее ERP-документов с буфером 31 день в обе стороны.
