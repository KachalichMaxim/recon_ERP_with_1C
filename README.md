...
Полная документная сверка 15.07.2026 на воспроизводимой выборке из 10 закрытых поставок с датами поставки `2025-06-01..2025-12-01`: p50 `10.47` сек, p95 `16.33` сек; ERP p50 `3.27` сек, REST 1C p50 `7.27` сек. Технических ошибок `0`. Background batch с двумя worker обработал тот же набор за `51.29` сек вместо `99.95` сек последовательно. Подробности: `docs/testing/E2E_RECENT_CLOSED_DELIVERIES_2026-07-15.md`.
