...
CREATE TABLE IF NOT EXISTS veda_reconciliation_runs (
    ...
    coverage_status VARCHAR(64) NOT NULL DEFAULT 'unknown',
    result_status VARCHAR(64) NOT NULL DEFAULT 'issues_found',
    ruleset_id VARCHAR(128) NULL,
    ruleset_version VARCHAR(32) NULL,
    application_version VARCHAR(32) NULL,
